...
<div class="container1">
    ...
    <div class="details">
      <div class="recentOrders">
        <div class="cardHeader">
          ...
          <a href="patient_reg.php" class="btn">Add</a>
        </div>
        <table id="myTable">
          <thead>
            <tr>
  ...
  while ($row=mysqli_fetch_assoc($run)) {
    ...
    <tr>
      ...
      <td> <img src="img/<?php echo $row['img'] ?>" alt="" style="height:40px;width:40px"> </td>
    <td> <a href="patien_details.php?id=<?php echo $row['id'] ;?>">View</a> </td>
    </tr>
