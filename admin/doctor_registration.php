    ...
    <div class="details">
      <div class="recentOrders">
        <div class="cardHeader">
          ...
          <a href="doctor.php" class="btn">View All Registered Doctor</a>
        </div>
        <div class="container">
...
if(isset($_POST["submit"])){
  ...
  $sql="insert into doctor(name,adhar,dob,gender,address,mobile,email,password,img,created_at)
  values('$name','$adhar','$dob','$gender','$address','$mobile','$email','$password','$file','$d')";
