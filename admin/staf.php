    ...
    <div class="details">
      <div class="recentOrders">
        <div class="cardHeader">
          <h2>Registered Staf</h2>
          <a href="staf_registration.php" class="btn">Add</a>
        </div>
        <table id="myTable">
          <thead>
            <tr>
          ...
          <tbody>
           ...
           while ($row=mysqli_fetch_assoc($run)) {
             ...
             <tr>
               ...
               <td> <img src="img/staf/<?php echo $row['img'] ?>" alt="" style="height:40px;width:40px"> </td>
             <td> <a href="staf_edit_reg.php?id=<?php echo $row['id'] ;?>">edit</a> /
               <a href="del_staf.php?id=<?php echo $row['id'] ;?>">delete</a> </td>
             </tr>
