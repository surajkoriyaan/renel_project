...
<div class="container1">
    ...
    <div class="details">
      <div class="recentOrders">
        <div class="cardHeader">
          ...
          <a href="admin_registration.php" class="btn">Add</a>
        </div>
        <table id="myTable">
          <thead>
            <tr>
  ...
  while ($row=mysqli_fetch_assoc($run)) {
    ...
    <tr>
      ...
      <td> <img src="img/admin/<?php echo $row['img'] ?>" alt="" style="height:40px;width:40px"> </td>
    <td> <a href="admin_reg_edit.php?id=<?php echo $row['id'] ;?>">edit</a> /
      <a href="del_admin.php?id=<?php echo $row['id'] ;?>">delete</a> </td>
    </tr>
